  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-penguin-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-penguin-elements-background-depth-2 border-y border-penguin-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-penguin-elements-terminals-buttonBackground text-penguin-elements-textSecondary hover:text-penguin-elements-textPrimary':
                            isActive,
                          'bg-penguin-elements-background-depth-2 text-penguin-elements-textSecondary hover:bg-penguin-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-penguin-elements-terminals-buttonBackground text-penguin-elements-textPrimary': isActive,
                            'bg-penguin-elements-background-depth-2 text-penguin-elements-textSecondary hover:bg-penguin-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-penguin-elements-textTertiary hover:text-penguin-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
