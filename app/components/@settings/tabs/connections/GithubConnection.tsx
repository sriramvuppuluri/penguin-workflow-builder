...
export default function GitHubConnection() {
  ...
  return (
    <motion.div
      className="bg-penguin-elements-background dark:bg-penguin-elements-background border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GithubLogo />
            <h3 className="text-base font-medium text-penguin-elements-textPrimary dark:text-penguin-elements-textPrimary">
              GitHub Connection
            </h3>
          </div>
        </div>
        ...
        {!connection.user && (
          <div className="text-xs text-penguin-elements-textSecondary bg-penguin-elements-background-depth-1 dark:bg-penguin-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-penguin-elements-icon-success dark:text-penguin-elements-icon-success" />
              <span className="font-medium">Tip:</span> You can also set the{' '}
              <code className="px-1 py-0.5 bg-penguin-elements-background-depth-2 dark:bg-penguin-elements-background-depth-2 rounded">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-penguin-elements-textSecondary dark:text-penguin-elements-textSecondary mb-2">
              Token Type
            </label>
            <select
              ...
              className={classNames(
                ...
                'bg-penguin-elements-background-depth-1 dark:bg-penguin-elements-background-depth-1',
                'border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor',
                'text-penguin-elements-textPrimary dark:text-penguin-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-penguin-elements-item-contentAccent dark:focus:ring-penguin-elements-item-contentAccent',
                'disabled:opacity-50',
              )}
            >
          ...
          <div>
            ...
            <input
              ...
              className={classNames(
                ...
                'text-penguin-elements-textPrimary placeholder-penguin-elements-textTertiary',
                'focus:outline-none focus:ring-1 focus:ring-penguin-elements-borderColorActive',
                'disabled:opacity-50',
              )}
            />
            <div className="mt-2 text-sm text-penguin-elements-textSecondary">
              <a
                href={`https://github.com/settings/tokens${connection.tokenType === 'fine-grained' ? '/beta' : '/new'}`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-penguin-elements-borderColorActive hover:underline inline-flex items-center gap-1"
              >
                Get your token
            ...
            <>
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-penguin-elements-textSecondary flex items-center gap-1">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="flex items-center gap-2 hover:bg-penguin-elements-item-backgroundActive/10 hover:text-penguin-elements-textPrimary dark:hover:text-penguin-elements-textPrimary transition-colors"
                  >
        ...
        {connection.user && connection.stats && (
          <div className="mt-6 border-t border-penguin-elements-borderColor dark:border-penguin-elements-borderColor pt-6">
            <div className="flex items-center gap-4 p-4 bg-penguin-elements-background-depth-1 dark:bg-penguin-elements-background-depth-1 rounded-lg mb-4">
              <img
                src={connection.user.avatar_url}
                alt={connection.user.login}
                className="w-12 h-12 rounded-full border-2 border-penguin-elements-item-contentAccent dark:border-penguin-elements-item-contentAccent"
              />
              <div>
                <h4 className="text-sm font-medium text-penguin-elements-textPrimary dark:text-penguin-elements-textPrimary">
                  {connection.user.name || connection.user.login}
                </h4>
                <p className="text-sm text-penguin-elements-textSecondary dark:text-penguin-elements-textSecondary">
            ...
            <Collapsible open={isStatsExpanded} onOpenChange={setIsStatsExpanded}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-penguin-elements-background dark:bg-penguin-elements-background-depth-2 border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor hover:border-penguin-elements-borderColorActive/70 dark:hover:border-penguin-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    <div className="i-ph:chart-bar w-4 h-4 text-penguin-elements-item-contentAccent" />
                    <span className="text-sm font-medium text-penguin-elements-textPrimary">GitHub Stats</span>
                  </div>
                  <div
                    className={classNames(
                      'i-ph:caret-down w-4 h-4 transform transition-transform duration-200 text-penguin-elements-textSecondary',
              ...
              <CollapsibleContent className="overflow-hidden">
                <div className="space-y-4 mt-4">
                  {/* Languages Section */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-penguin-elements-textPrimary mb-3">Top Languages</h4>
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(connection.stats.languages)
                        ...
                        .map(([language]) => (
                          <span
                            key={language}
                            className="px-3 py-1 text-xs rounded-full bg-penguin-elements-sidebar-buttonBackgroundDefault text-penguin-elements-sidebar-buttonText"
                          >
                            {language}
                          </span>
                        ))}
                  ...
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex flex-col p-3 rounded-lg bg-penguin-elements-background-depth-2 dark:bg-penguin-elements-background-depth-2 border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor"
                      >
                        <span className="text-xs text-penguin-elements-textSecondary">{stat.label}</span>
                        <span className="text-lg font-medium text-penguin-elements-textPrimary">{stat.value}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-sm font-medium text-penguin-elements-textPrimary mb-2">Repository Stats</h5>
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-penguin-elements-textPrimary mb-2">Contribution Stats</h5>
                          ...
                          {[
                            {
                              ...
                              icon: 'i-ph:star',
                              iconColor: 'text-penguin-elements-icon-warning',
                            },
                            {
                              label: 'Forks',
                              value: connection.stats.forks || 0,
                              icon: 'i-ph:git-fork',
                              iconColor: 'text-penguin-elements-icon-info',
                            },
                            {
                              label: 'Followers',
                              value: connection.stats.followers || 0,
                              icon: 'i-ph:users',
                              iconColor: 'text-penguin-elements-icon-success',
                            },
                          ].map((stat, index) => (
                            <div
                              key={index}
                            ...
                            >
                              <span className="text-xs text-penguin-elements-textSecondary">{stat.label}</span>
                              <span className="text-lg font-medium text-penguin-elements-textPrimary flex items-center gap-1">
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-penguin-elements-textPrimary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                      ...
                      <div className="pt-2 border-t border-penguin-elements-borderColor">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-penguin-elements-textPrimary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-4 rounded-lg bg-penguin-elements-background-depth-1 dark:bg-penguin-elements-background-depth-1 border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor hover:border-penguin-elements-borderColorActive dark:hover:border-penguin-elements-borderColorActive transition-all duration-200"
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-branch w-4 h-4 text-penguin-elements-icon-tertiary" />
                                <h5 className="text-sm font-medium text-penguin-elements-textPrimary group-hover:text-penguin-elements-item-contentAccent transition-colors">
                                  {repo.name}
                                </h5>
                              </div>
                              <div className="flex items-center gap-3 text-xs text-penguin-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <div className="i-ph:star w-3.5 h-3.5 text-penguin-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <div className="i-ph:git-fork w-3.5 h-3.5 text-penguin-elements-icon-info" />
                            ...
                            {repo.description && (
                              <p className="text-xs text-penguin-elements-textSecondary line-clamp-2">
                                {repo.description}
                              </p>
                            )}
                            ...
                            <div className="flex items-center gap-3 text-xs text-penguin-elements-textSecondary">
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-penguin-elements-item-contentAccent transition-colors">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-penguin-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
