      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-penguin-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-penguin-elements-item-backgroundAccent hover:bg-penguin-elements-artifacts-backgroundHover"
