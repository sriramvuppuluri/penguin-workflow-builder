      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__boltSelectedElement__')) {
            ...
            return (
              <div className="bg-penguin-elements-background-depth-3 border border-penguin-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-penguin-elements-background-depth-2 px-2 py-1 rounded text-penguin-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-penguin-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-penguin-elements-textSecondary !bg-penguin-elements-background-depth-2 border border-penguin-elements-borderColor p-2 rounded">
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-penguin-elements-item-backgroundAccent text-penguin-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
