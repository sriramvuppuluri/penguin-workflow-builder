        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-penguin-elements-background-depth-2 dark:bg-penguin-elements-background-depth-3 text-penguin-elements-textPrimary dark:text-penguin-elements-textPrimary-dark hover:bg-penguin-elements-background-depth-3 dark:hover:bg-penguin-elements-background-depth-4 border border-penguin-elements-borderColor dark:border-penguin-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
