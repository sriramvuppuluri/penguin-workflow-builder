      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-penguin-elements-textPrimary dark:text-penguin-elements-textPrimary-dark'
              : 'text-penguin-elements-textSecondary dark:text-penguin-elements-textSecondary-dark hover:text-penguin-elements-textPrimary dark:hover:text-penguin-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-penguin-elements-textTertiary dark:text-penguin-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
