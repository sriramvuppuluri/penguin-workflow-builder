  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-penguin-elements-borderColor bg-penguin-elements-background-depth-1 text-penguin-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-penguin-elements-textSecondary', className)} {...props} />;
  },
);
